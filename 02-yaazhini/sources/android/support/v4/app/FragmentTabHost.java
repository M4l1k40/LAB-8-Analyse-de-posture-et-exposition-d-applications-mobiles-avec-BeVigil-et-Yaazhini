...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public void addTab(TabHost.TabSpec tabSpec, Class<?> clss, Bundle args) {
        ...
        if (this.mAttached) {
            Fragment unused = info.fragment = this.mFragmentManager.findFragmentByTag(tag);
    ...
    public void onAttachedToWindow() {
        ...
        for (int i = 0; i < this.mTabs.size(); i++) {
            ...
            Fragment unused = tab.fragment = this.mFragmentManager.findFragmentByTag(tab.tag);
        ...
        if (this.mLastTab != newTab) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    Fragment unused = newTab.fragment = Fragment.instantiate(this.mContext, newTab.clss.getName(), newTab.args);
