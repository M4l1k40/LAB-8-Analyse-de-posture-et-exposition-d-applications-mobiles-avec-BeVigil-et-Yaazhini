...
public class Toolbar extends ViewGroup {
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new ImageButton(getContext(), (AttributeSet) null, R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new ImageButton(getContext(), (AttributeSet) null, R.attr.toolbarNavigationButtonStyle);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredHeight = ViewCompat.resolveSizeAndState(Math.max(height3, getSuggestedMinimumHeight()), i7, childState << 16);
        if (shouldCollapse()) {
            measuredHeight = 0;
        }
