...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
            ...
            public void run() {
                if (RecyclerView.this.mFirstLayoutComplete && !RecyclerView.this.isLayoutRequested()) {
                    if (RecyclerView.this.mLayoutFrozen) {
                        boolean unused = RecyclerView.this.mLayoutRequestEaten = true;
                    } else {
        ...
        this.mItemAnimatorRunner = new Runnable() {
            public void run() {
                ...
                boolean unused = RecyclerView.this.mPostedAnimatorRunner = false;
            }
        };
        ...
        setWillNotDraw(ViewCompat.getOverScrollMode(this) == 2 ? true : z2);
    ...
    private void setAdapterInternal(Adapter adapter, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
        ...
        boolean unused = this.mState.mStructureChanged = true;
    ...
    public void onMeasure(int widthSpec, int heightSpec) {
        if (this.mAdapterUpdateDuringMeasure) {
            ...
            if (this.mState.mRunPredictiveAnimations) {
                boolean unused = this.mState.mInPreLayout = true;
            } else {
                this.mAdapterHelper.consumeUpdatesInOnePass();
                boolean unused2 = this.mState.mInPreLayout = false;
            }
        ...
        boolean unused3 = this.mState.mInPreLayout = false;
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        boolean unused = state.mRunSimpleAnimations = z;
        ...
        boolean unused2 = state2.mRunPredictiveAnimations = z2;
    }
    ...
    public void dispatchLayout() {
        if (this.mAdapter == null) {
            ...
            onEnterLayoutOrScroll();
            processAdapterUpdatesAndSetAnimationFlags();
            boolean unused = this.mState.mTrackOldChangeHolders = this.mState.mRunSimpleAnimations && this.mItemsChanged;
            this.mItemsChanged = false;
            this.mItemsAddedOrRemoved = false;
            boolean unused2 = this.mState.mInPreLayout = this.mState.mRunPredictiveAnimations;
            this.mState.mItemCount = this.mAdapter.getItemCount();
            ...
            if (this.mState.mRunPredictiveAnimations) {
                ...
                boolean unused3 = this.mState.mStructureChanged = false;
                this.mLayout.onLayoutChildren(this.mRecycler, this.mState);
                boolean unused4 = this.mState.mStructureChanged = didStructureChange;
            ...
            this.mState.mItemCount = this.mAdapter.getItemCount();
            int unused5 = this.mState.mDeletedInvisibleItemCountSincePreviousLayout = 0;
            boolean unused6 = this.mState.mInPreLayout = false;
            this.mLayout.onLayoutChildren(this.mRecycler, this.mState);
            boolean unused7 = this.mState.mStructureChanged = false;
            this.mPendingSavedState = null;
            boolean unused8 = this.mState.mRunSimpleAnimations = this.mState.mRunSimpleAnimations && this.mItemAnimator != null;
            if (this.mState.mRunSimpleAnimations) {
            ...
            resumeRequestLayout(false);
            this.mLayout.removeAndRecycleScrapInt(this.mRecycler);
            int unused9 = this.mState.mPreviousLayoutItemCount = this.mState.mItemCount;
            this.mDataSetHasChangedAfterLayout = false;
            boolean unused10 = this.mState.mRunSimpleAnimations = false;
            boolean unused11 = this.mState.mRunPredictiveAnimations = false;
            onExitLayoutOrScroll();
            boolean unused12 = this.mLayout.mRequestedSimpleAnimations = false;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (holder != null && !holder.shouldIgnore()) {
                if (holder.mPosition >= positionEnd) {
                    ...
                    boolean unused2 = this.mState.mStructureChanged = true;
                }
            }
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            if (RecyclerView.this.mAdapter.hasStableIds()) {
                boolean unused = RecyclerView.this.mState.mStructureChanged = true;
                RecyclerView.this.setDataSetChangedAfterLayout();
            } else {
                boolean unused2 = RecyclerView.this.mState.mStructureChanged = true;
                RecyclerView.this.setDataSetChangedAfterLayout();
            }
        ...
        public void triggerUpdateProcessor() {
            if (!RecyclerView.this.mPostUpdatesOnAnimation || !RecyclerView.this.mHasFixedSize || !RecyclerView.this.mIsAttached) {
                boolean unused = RecyclerView.this.mAdapterUpdateDuringMeasure = true;
                RecyclerView.this.requestLayout();
                return;
            }
    ...
    public final class Recycler {
        ...
        public void recycleCachedViewAt(int cachedViewIndex) {
            addViewHolderToRecycledViewPool(this.mCachedViews.get(cachedViewIndex));
        ...
        public ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            while (true) {
                ...
                holder = this.mAttachedScrap.get(i);
