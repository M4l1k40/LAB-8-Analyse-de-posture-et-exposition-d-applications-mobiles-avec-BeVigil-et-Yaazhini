...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private static class MoveInfo {
        ...
        private MoveInfo(RecyclerView.ViewHolder holder2, int fromX2, int fromY2, int toX2, int toY2) {
            this.holder = holder2;
            this.fromX = fromX2;
            this.fromY = fromY2;
            this.toX = toX2;
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder2, RecyclerView.ViewHolder newHolder2, int fromX2, int fromY2, int toX2, int toY2) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new Runnable() {
                    public void run() {
                        ...
                        while (i$.hasNext()) {
                            DefaultItemAnimator.this.animateAddImpl((RecyclerView.ViewHolder) i$.next());
                        }
                        additions.clear();
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationEnd(View view) {
                    oldViewAnim.setListener((ViewPropertyAnimatorListener) null);
                    ViewCompat.setAlpha(view, 1.0f);
                    ViewCompat.setTranslationX(view, 0.0f);
                    ViewCompat.setTranslationY(view, 0.0f);
