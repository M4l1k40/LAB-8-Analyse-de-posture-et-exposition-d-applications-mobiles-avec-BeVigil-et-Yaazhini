        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (this.mTextView != null) {
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (TabLayout.this.mMode == 1 && textSize > curTextSize && curLineCount == 1 && ((layout = this.mTextView.getLayout()) == null || approximateLineWidth(layout, 0, textSize) > ((float) layout.getWidth()))) {
