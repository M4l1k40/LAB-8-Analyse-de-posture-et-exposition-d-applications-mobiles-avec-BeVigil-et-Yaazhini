...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void buildShadowCorners() {
        ...
        if (shadowRadius > 0.0f) {
            ...
            this.mCornerShadowPaint.setShader(new RadialGradient(0.0f, 0.0f, shadowRadius, new int[]{0, this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, startRatio, startRatio + ((SHADOW_BOTTOM_SCALE - startRatio) / 2.0f), 1.0f}, Shader.TileMode.CLAMP));
        }
